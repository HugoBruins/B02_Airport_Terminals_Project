...
corr_matrix = corr_matrix.drop(column_names[0: 19], axis = 1)
corr_matrix = corr_matrix.drop(column_names[19:], axis = 0)

print(corr_matrix)
sn.heatmap(corr_matrix, annot=True, cmap="Reds", linewidth=.5)
...
abbrev_inputs = ["TotPass", "CallToGateStrat", "NPax1", "NPax2", "NPax3", "NPax4", "NPax5", "NPax6", "NPax7", "C7200-6300", "C6300-5400", "C5400-4500", "C4500-3600", "C3600-2700", "S<1800", "S1800-3600", "S7200-9000", "S9000-10800", "S>10800"]
abbrev_outputs = ["Avg. Que TimeCl", "Avg. Que TimeSC", "Avg. Time to Gate", "Pax. Check-In Compl.SC", "Pax. Check-In Compl.CL", "No. Missed Flights", "Total Expenditure", "Avg. Max Pax in QueCL", "Max Pax. in QueSC"]
plt.xticks([1,2,3,4,5,6,7,8,9], abbrev_outputs, rotation=45, ha='right', minor=False)
